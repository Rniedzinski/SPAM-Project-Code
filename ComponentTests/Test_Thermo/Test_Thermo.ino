 ...
 * https://github.com/sparkfun/SparkFun_MLX90614_Arduino_Library/tree/master/examples
 * MLX90614_Serial_Demo
 * 
 * Last Modified 3/20/2016
 * 
 * Purpose: connect MLX90614 Thermometer to Arduino Mega and output IR temperatures 
 * to the Serial Monitor
 * 
 * Must include library from https://github.com/sparkfun/SparkFun_MLX90614_Arduino_Library
 */
